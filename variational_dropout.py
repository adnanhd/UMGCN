...
class VariationalDropout(nn.Module):
    def __init__(self, input_size, out_size, log_sigma2=-10, threshold=3):
        ...
        self.log_sigma2 = Parameter(t.FloatTensor(input_size, out_size).fill_(
        ...
        # as it said, this is used for zero the weight if the Gaussian noise ball has too large radius.
    ...
    def forward(self, input):
        ...
        # a reparameterization trick to form the Gaussian dropout
